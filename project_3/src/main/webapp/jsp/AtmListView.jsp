	...
	<div>
		<form class="pb-5" action="<%=ORSView.ATM_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="location" placeholder="Enter projectName"
						class="form-control"
				...
				&emsp;
					<div class="col-sm-3"><%=HTMLUtility.getList("dob", DataUtility.getDateString(dto.getDob()), proList)%></div>

		<%-- 		<div class="col-sm-3"><%=HTMLUtility.getList("location", DataUtility.getString(dto.getLocation()), proList)%></div>
 --%>				&emsp;
				<div class="col-sm-2">
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="20%" class="text">Remark</th>
