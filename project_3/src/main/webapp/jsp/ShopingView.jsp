...
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/update.png');
...
<body class="hm">
	...
	<div>
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Update shoping </h3>
							<%
								} else {
							%>
							<h3 class="text-center default-text text-primary">Add Shoping</h3>
							<%
								}
							%>
							<!--Body-->
		...
		<span class="pl-sm-5"><b>Product Name</b>
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="ProductName" value="<%=DataUtility.getStringData(dto.getProductName())%>">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("Name", request)%></font></br>			
	<span class="pl-sm-5"><b>Product Price</b>
		<span style="color: red;">*</span></span> </br>
		<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" class="form-control" name="price" placeholder="ProductPrice" value="<%=DataUtility.getStringData(dto.getProductPrice())%>">
      </div>
    </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="datepicker2" name="dob" class="form-control" placeholder="Date Of Birth" readonly="readonly" value="<%=DataUtility.getDateString(dto.getDate()) %>">
      </div>
    </div>	
