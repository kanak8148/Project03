...
public class JasperCtl extends BaseCtl {
	...
	/**
	 * 
	 * jasper report is java class  libreary it is meant for those devloper who need to add reporting capbliteies to thire application.
	 * 
	 */
