...
public class OrderCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		System.out.println("in orderctl validate method");
		boolean pass = true;
		...
		if (DataValidator.isNull(request.getParameter("Catagory"))) {
			System.out.println("============ " + request.getParameter("Catagory"));
			request.setAttribute("Catagory", PropertyReader.getValue("error.require", "Catagory"));
			pass = false;
		}
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		System.out.println("Catagory =====> " + request.getParameter("Catagory"));
		dto.setCategory(request.getParameter("Catagory"));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("u4rfh/iphr4t.cvuij");
